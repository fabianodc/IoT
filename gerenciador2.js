...
router.route('/temperatura').post(function(req, res) {
	...
	temperatura.valor = new Date();//= req.body.valor;
...
//GET /humidade/recente
router.route('/humidade/recente').get(function(req, res) {
	var limit =  1;
	var sort  = -1;
	Humidade.
	find().
	limit(limit).
	sort({ _id: sort })
	.exec(function(err, humidade) {
		if (err)
			res.send(err);

		res.json(humidade);
	});
	console.log('GET /humidade/recente');
});

//GET /humidade/elevada
router.route('/humidade/elevada').get(function(req, res) {
	var limit = 10;
	var valor = {$gte: 30};
	var sort =  -1;
    ...
    console.log('GET /humidade/elevada');
});
...
router.route('/humidade').post(function(req, res) {
	...
	humidade.valor = new Date();//req.body.valor;
...
router.route('/sensor1').post(function(req, res) {
	...
	sensor1.time = new Date();//req.body.time;
...
router.route('/atuador1').post(function(req, res) {
	...
	atuador1.valor = new Date();//= req.body.valor;
...
router.route('/sensor2').post(function(req, res) {
	...
	sensor2.valor = new Date();//= req.body.valor;
...
router.route('/atuador2').post(function(req, res) {
	...
	atuador2.valor = new Date();//= req.body.valor;
...
router.route('/sensor3').post(function(req, res) {
	...
	sensor3.valor = new Date();//= req.body.valor;
...
router.route('/atuador3').post(function(req, res) {
	...
	atuador3.valor = new Date();//= req.body.valor;
...
router.route('/luisa').post(function(req, res) {
	...
	luisa.valor = new Date();//= req.body.valor;
