...
router.route('/sensor1').post(function(req, res) {
	...
	client.publish('topic-iot-cefetmg',  sensor1.valor); //MQTT: publica o valor da sensor1 no Tópico
...
router.route('/atuador1').post(function(req, res) {
	...
	client.publish('topic-iot-cefetmg',  atuador1.valor); //MQTT: publica o valor da atuador1 no Tópico
...
router.route('/sensor2').post(function(req, res) {
	...
	client.publish('topic-iot-cefetmg',  sensor2.valor); //MQTT: publica o valor da sensor2 no Tópico
...
router.route('/atuador2').post(function(req, res) {
	...
	client.publish('topic-iot-cefetmg',  atuador2.valor); //MQTT: publica o valor da atuador2 no Tópico
...
router.route('/sensor3').post(function(req, res) {
	...
	client.publish('topic-iot-cefetmg',  sensor3.valor); //MQTT: publica o valor da sensor3 no Tópico
...
router.route('/atuador3').post(function(req, res) {
	...
	client.publish('topic-iot-cefetmg',  atuador3.valor); //MQTT: publica o valor da atuador3 no Tópico
...
router.route('/luisa').post(function(req, res) {
	...
	client.publish('topic-iot-cefetmg',  luisa.valor); //MQTT: publica o valor da luisa no Tópico
